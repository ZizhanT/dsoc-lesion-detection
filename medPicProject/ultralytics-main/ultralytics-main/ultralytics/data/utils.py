...
class HUBDatasetStats:
    ...
    Args:
        path (str): Path to data.yaml or data.zip (with data.yaml inside data.zip). Default is 'yoloData.yaml'.
    ...
    def __init__(self, path="yoloData.yaml", task="detect", autodownload=False):
        """Initialize class."""
