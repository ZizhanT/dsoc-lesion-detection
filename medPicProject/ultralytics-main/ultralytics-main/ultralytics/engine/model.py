...
class Model(torch.nn.Module):
    ...
    Examples:
        ...
        >>> model.train(data="yoloData.yaml", epochs=3)
        >>> metrics = model.val()
    ...
    def val(
        ...
        **kwargs: Any,
        ...
        Examples:
            >>> model = YOLO("yolo11n.pt")
            >>> results = model.val(data="yoloData.yaml", imgsz=640)
    ...
    def benchmark(
        ...
        **kwargs: Any,
        ...
        Examples:
            >>> model = YOLO("yolo11n.pt")
            >>> results = model.benchmark(data="yoloData.yaml", imgsz=640, half=True)
            >>> print(results)
        """
        self._check_is_pytorch_model()
    ...
    def train(
        ...
        **kwargs: Any,
        ...
        Examples:
            >>> model = YOLO("yolo11n.pt")
            >>> results = model.train(data="yoloData.yaml", epochs=3)
        """
        self._check_is_pytorch_model()
    ...
    def add_callback(self, event: str, func) -> None:
        ...
        Examples:
            ...
            >>> model.train(data="yoloData.yaml", epochs=1)
        """
